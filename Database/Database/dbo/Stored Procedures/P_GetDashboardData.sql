...
SELECT RT.TEMPLATE_GROUP_ID AS GROUP_ID,SUM(AMOUNT) AS CONSILED_AMOUNT, NULL AS NON_CONSILED_AMOUNT FROM RECONSILEDDATA RD
...
UNION
SELECT RT.TEMPLATE_GROUP_ID AS GROUP_ID,NULL AS CONSILED_AMOUNT, SUM(AMOUNT) AS NON_CONSILED_AMOUNT FROM RECONSILERAWDATA RRD
...
SELECT  TEMPLATEGROUP_ID  AS TemplateGroupId,SUM(CONSILED_AMOUNT) AS ConsiledAmount,SUM(NON_CONSILED_AMOUNT) AS NonConsiledAmount,TG.TEMPLATE_GROUP_NAME AS TemplateGroupName FROM DASHBOARDRESULT DR
