function apiGetCallController(n,t,i,r,u,f){urlString="/"+n+"/"+t;$(document).ready(function(){$.ajax({url:urlString,type:i,data:r,async:!0,success:function(n){u&&typeof u=="function"&&u(n)},failure:function(n){alert(n.responseText)},error:function(n,t,i){console.log("The following error occurred: "+n.responseJSON.error);console.log(n,t,i);f&&typeof f=="function"&&f(jQuery.parseJSON(n.responseJSON).error)}})})}function getNowDate(){var i=new Date,n=""+(i.getMonth()+1),t=""+i.getDate(),r=i.getFullYear();return n.length<2&&(n="0"+n),t.length<2&&(t="0"+t),[r,n,t].join("-")}function IsNullOrUndefinedOrBlank(n){return n===undefined||n===null||n===""?!0:!1}function AllowNumbersOnly(n){var t=n.which?n.which:n.keyCode;t>31&&(t<48||t>57)&&n.preventDefault()}function typeWriter(n,t,r){i<t.length&&(document.getElementById(n).innerHTML+=t.charAt(i),i++,setTimeout(typeWriter,r))}function setTextValue(n,t){document.getElementById(n).value=t}$(document).ready(function(){var n=$("#roleData").DataTable();$("#roleData").on("click",".btn-bootstrap-dialog",function(){var n=$(this).data("url"),t=$(this).attr("title");$.get(n,function(n){$("#bootstrapDialog").html(n);$("#bootstrapDialog").modal("show");$("#ModalPopUp").find("#myModalLabel").html($(this).attr("title"))})});$(".addRoleMasterbtn").click(function(){var n=$(this).data("url"),t=$(this).attr("title");$.get(n,function(n){$("#bootstrapDialog").html(n);$("#bootstrapDialog").modal("show");$("#ModalPopUp").find("#myModalLabel").html($(this).attr("title"))})});$(function(){function t(){var r=$(this),t=r.prop("checked"),i=r.parent(),u=i.siblings();i.find('input[type="checkbox"]').prop({indeterminate:!1,checked:t}).siblings("label").removeClass("custom-checked custom-unchecked custom-indeterminate").addClass(t?"custom-checked":"custom-unchecked");n(i,t)}function n(t,i){var r=t.parent().parent(),u=!0,f=!1;t.siblings().each(function(){return u=$(this).children('input[type="checkbox"]').prop("checked")===i});u&&i?(r.children('input[type="checkbox"]').prop({indeterminate:!1,checked:i}).siblings("label").removeClass("custom-checked custom-unchecked custom-indeterminate").addClass(i?"custom-checked":"custom-unchecked"),n(r,i)):u&&!i?(f=r.find('input[type="checkbox"]:checked').length>0,r.children('input[type="checkbox"]').prop("checked",i).prop("indeterminate",f).siblings("label").removeClass("custom-checked custom-unchecked custom-indeterminate").addClass(f?"custom-indeterminate":i?"custom-checked":"custom-unchecked"),n(r,i)):t.parents("li").children('input[type="checkbox"]').prop({indeterminate:!0,checked:!1}).siblings("label").removeClass("custom-checked custom-unchecked custom-indeterminate").addClass("custom-indeterminate")}$('input[type="checkbox"]').change(t);$("#roleEdit").submit(function(){var t=[],n;singleObj={};n="";n=document.getElementById("RoleId").value;$('input[type="checkbox"]').each(function(){$(this).is(":checked")&&(singleObj={},singleObj.SubmenuId=this.id,singleObj.RoleId=n,t.push(singleObj))});n!=""&&apiGetCallController("RoleMaster","EditrecordAPICall","POST",{selectedMenuId:t},function(){window.location.href="/RoleMaster/Index"},function(n){return $.notify(n,"danger"),!1})});$("#roleAdd").submit(function(){var t=[],n;singleObj={};n="";n=document.getElementById("RoleName").value;$('input[type="checkbox"]').each(function(){$(this).is(":checked")&&(singleObj={},singleObj.SubmenuId=this.id,singleObj.RoleName=n,t.push(singleObj))});n!=""&&apiGetCallController("RoleMaster","AddrecordAPICall","POST",{selectedMenuId:t},function(){window.location.href="/RoleMaster/Index"},function(n){return $.notify(n,"danger"),!1})})})});
/*!
 DataTables 1.10.16
