...
(function (jsPDF) {
	 ...
	 */
    jsPDF.API.autoTable = function (headers, data, options, callback) {
            ...
            success:
                ...
                function (data) {
                    $.ajax({
                        type: 'GET',
                        async: true,
                        url: calculateWidths(doc, pageSize.width),
                        success:
